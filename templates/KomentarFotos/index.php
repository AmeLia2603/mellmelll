 ...
 * @var \App\Model\Entity\KomentarFoto[]|\Cake\Collection\CollectionInterface $komentarFotos
 */
?>

<?php
$this->assign('title', __('Komentar Fotos'));
$this->Breadcrumbs->add([
    ['title' => __('Home'), 'url' => '/'],
    ['title' => __('List Komentar Fotos')],
]);
?>
...
<div class="card card-primary card-outline">
    <div class="card-header d-flex flex-column flex-md-row">
        ...
        <div class="d-flex ml-auto">
            ...
            <?= $this->Html->link(__('New Komentar Foto'), ['action' => 'add'], ['class' => 'btn btn-primary btn-sm ml-2']) ?>
        </div>
    </div>
    <!-- /.card-header -->
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <tbody>
                <?php foreach ($komentarFotos as $komentarFoto) : ?>
                    <tr>
